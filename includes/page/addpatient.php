<div class="row">
    <h1> Ajouter un patient <small></small></h1>

    <div class="col-md-12">
        <form action="addpatient/" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-group">
                <div class="col-sm-offset-4 col-sm-8">
                    <button type="submit" name="submit_addpatient" value="1" class="btn btn-success btn-lg">Ajouter</button>
                </div>
            </div>    
        </form>
    </div>
