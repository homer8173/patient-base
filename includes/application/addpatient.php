...
if (isset($_POST['submit_addpatient'])) {
    ...
    if (!isset($error))
        if ($db->Query("INSERT INTO `users` ( `user`, `password`, `username`, `email`, `user_group`, `sex`, `birthdate`, `picture`, `telephone`, `prefersms`, `comment`) "
                        . "VALUES ('" . $_POST['user'] . "', MD5('" . $_POST['password'] . "'), '" . $_POST['username'] . "', '" . $_POST['email'] . "', '3', '" . $_POST['sex'] . "', '$birthdate', '$filename', '" . $_POST['telephone'] . "', '" . $_POST['prefersms'] . "', '" . $_POST['comment'] . "')")) {
